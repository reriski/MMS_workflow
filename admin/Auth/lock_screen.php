        ...
        <div class="page-lock">
            <div class="page-logo">
                <a class="brand" href="index.html">
                    <img src="../../assets/global/img/logo.png">
                </a>
            </div>
            <div class="page-body">
                    ...
                    <div class="lock-cont">
                        <div class="lock-item">
                            <div class="pull-left lock-avatar-block">
                                <img src="../../assets/pages/media/profile/photo3.jpg" class="lock-avatar"> 
                            </div>
                        </div>
                        <div class="lock-item lock-item-full">
                            <form class="lock-form pull-left" action="index.html" method="post">
                                ...
                                <div class="form-actions">
                                    <a href="../Dashboard/" type="submit" class="btn red uppercase">Login</a>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <div class="page-footer-custom"> 2017 HackJak. Admin Dashboard. </div>
        </div>
        <!--[if lt IE 9]>
