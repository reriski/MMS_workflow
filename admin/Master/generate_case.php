            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-title">
                        <h1>
                            Workflow Dashboard
                            <small>Generate Case Baru</small>
                        </h1>
                    </div>
                    <!-- END PAGE TITLE -->
                    <!-- BEGIN PAGE TOOLBAR -->
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <span class="active">Generate Case</span>
                    </li>
                </ul>
                <div class="row">
                  <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Add Generate Case</span>
                                    </div>
                                </div>
                                    ...
                                    <form action="#" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Judul
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Nama Requestor
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-5">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Email Requestor
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-5">
