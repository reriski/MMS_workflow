        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <span class="active">Edit Template</span>
                    </li>
                </ul>
                <div class="row">
                  <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Edit Template</span>
                                    </div>
                                </div>
                                    ...
                                    <form action="#" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Nama Template
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" placeholder="" name="name" value="  DEFAULT_ON_COMPLETE_ACTIVITY">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">enter your full name</span>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-2 control-label" for="form_control_1">Tipe
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-5">
                                                    <select class="form-control" name="aktif">
                                                        <option value="email" selected>Email Notifikasi</option>
                                            ...
                                            <div class="form-group last">
                                                <label class="control-label col-md-2">HTML Template
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="template" rows="6" data-error-container="#editor2_error">Test Text</textarea>
