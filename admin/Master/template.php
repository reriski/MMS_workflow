            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-title">
                        <h1>
                            Template Dashboard
                            <small>Buat Template Anda sendiri di sini</small>
                        </h1>
                    </div>
                    <!-- END PAGE TITLE -->
                    <!-- BEGIN PAGE TOOLBAR -->
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> Daftar Template</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="btn-group">
                                                    <a href="tambah_template.php" id="sample_editable_1_2_new" class="btn sbold green"> Tambah Template
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1_2">
                                        ...
                                        <tbody>
                                            <tr class="odd gradeX">
                                                ...
                                                <td> DEFAULT_ON_ENTER_ACTIVITY </td>
                                                <td>
                                                    Email Notifikasi
                                                </td>
                                                <td>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td>DEFAULT_ON_COMPLETE_ACTIVITY </td>
                                                <td>
                                                    Email Notifikasi
                                                </td>
                                                <td>
