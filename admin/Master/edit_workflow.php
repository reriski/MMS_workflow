            ...
            <div class="page-content">
                ...
                <div class="page-head">
                    ...
                    <div class="page-title">
                        <h1>
                            Workflow Dashboard
                            <small>Menambah Workflow Baru</small>
                        </h1>
                    </div>
                    <!-- END PAGE TITLE -->
                    <!-- BEGIN PAGE TOOLBAR -->
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <span class="active">Edit Workflow</span>
                    </li>
                </ul>
                <div class="row">
                  <div class="col-md-12">
                                    ...
                                    <form action="#" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control" placeholder="" name="name" value="ComplainRPTRA">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-5">
                                                    <textarea class="form-control" name="keterangan" rows="3">Complain RPTRA</textarea>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="date" class="form-control" placeholder="" name="date" value="2017-12-08">
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
