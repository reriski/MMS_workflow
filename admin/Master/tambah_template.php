        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <ul class="page-breadcrumb breadcrumb">
                    ...
                    <li>
                        <a href="workflow.php">Template</a>
                        <i class="fa fa-circle"></i>
                    </li>
                    <li>
                        <span class="active">Tambah Template</span>
                    </li>
                </ul>
                <div class="row">
                  <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Tambah Template</span>
                                    </div>
                                </div>
                                    ...
                                    <form action="#" class="form-horizontal" id="form_sample_1">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="ckeditor form-control" name="template" rows="6" data-error-container="#editor2_error"></textarea>
